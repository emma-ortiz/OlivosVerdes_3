...
# ======================================================================
# 8. Pedido (Para seguimiento de envíos)
# ======================================================================
class Pedido(models.Model):
    compra = models.OneToOneField(Compra, on_delete=models.CASCADE)
    fecha_envio = models.DateTimeField(null=True, blank=True)
    fecha_entrega = models.DateTimeField(null=True, blank=True)
    estado_envio = models.CharField(max_length=50, default='En preparación')

    def __str__(self):
        return f"Pedido para Compra #{self.compra.id} - Estado: {self.estado_envio}"    
    
# ======================================================================
# 9. ItemPedido (Productos específicos en el Pedido)
# ======================================================================
